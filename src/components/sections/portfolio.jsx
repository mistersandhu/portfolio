            ...
            <div className="container">
                <div className="container-inner">
                    ...
                    <div className="row project-masonry-active overflow-hidden">
                        {filteredProjects.map(({ category, id, src, title, slug }) => <Card key={id} id={id} category={category} src={src} title={title} slug={slug} animationClass={animationClass} />)}
            ...
            <SlideUp delay={id}>
                <div className="project-item style-two">
                    <div className="project-image">
                        ...
                        <Link href={`/projects/${slug}`} className="details-btn"><RiArrowRightUpLine /> </Link>
                    </div>
